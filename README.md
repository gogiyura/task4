...
(пример: исходный «qwerty», новый «erty»). Размер файла не должен превышать 1Кб (достаточно нескольких строк). «Слово» следует рассматривать как непрерывную последовательность кириллических или латинских символов.
